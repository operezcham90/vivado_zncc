...
HD_PWD='C:/Users/dell_/Documents/vivado_zncc/bram_comm_2/bram_comm_2.runs/soc_util_vector_logic_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_util_vector_logic_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_util_vector_logic_0_6.tcl

...
HD_PWD='C:/Users/dell_/Documents/vivado_zncc/bram_comm_2/bram_comm_2.runs/soc_util_reduced_logic_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_util_reduced_logic_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_util_reduced_logic_0_1.tcl

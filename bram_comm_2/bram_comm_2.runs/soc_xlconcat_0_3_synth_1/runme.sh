...
HD_PWD='C:/Users/dell_/bram_comm_2/bram_comm_2.runs/soc_xlconcat_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_xlconcat_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_xlconcat_0_3.tcl

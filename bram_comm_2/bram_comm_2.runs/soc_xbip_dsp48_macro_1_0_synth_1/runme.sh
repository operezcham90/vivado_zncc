...
HD_PWD='C:/Users/dell_/Documents/vivado_zncc/bram_comm_2/bram_comm_2.runs/soc_xbip_dsp48_macro_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_xbip_dsp48_macro_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_xbip_dsp48_macro_1_0.tcl

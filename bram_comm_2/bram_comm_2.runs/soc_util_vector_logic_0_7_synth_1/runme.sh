...
HD_PWD='C:/Users/dell_/bram_comm_2/bram_comm_2.runs/soc_util_vector_logic_0_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_util_vector_logic_0_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_util_vector_logic_0_7.tcl
